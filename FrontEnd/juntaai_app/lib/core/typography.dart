...
class AppTypography {
  ...
  // 📋 MENU (NOVOS ESTILOS)
  // =========================
  static final menuTitle = _base(size: 16, weight: FontWeight.w500); // "Menu"
  static final menuItem = _base(size: 13, weight: FontWeight.w400); // Itens padrão
  static final menuItemBold = _base(size: 13, weight: FontWeight.w500); // "Sair"
}
