...
class ConteudoInformativo(Base):
    ...
    Acessa_Usuaria_Conteudo: Mapped[list['AcessaUsuariaConteudo']] = relationship('AcessaUsuariaConteudo', back_populates='Conteudo_Informativo')


class RedeApoio(Base):
...
class Usuaria(Base):
    ...
    Rede_Apoio: Mapped[list['RedeApoio']] = relationship('RedeApoio', secondary='Utiliza_Rede_Apoio_Usuaria', back_populates='Usuaria')
    Tipo_Violencia: Mapped[list['TipoViolencia']] = relationship('TipoViolencia', secondary='Sofre_Tipo_Violencia_Usuaria', back_populates='Usuaria')
    Acessa_Usuaria_Conteudo: Mapped[list['AcessaUsuariaConteudo']] = relationship('AcessaUsuariaConteudo', back_populates='Usuaria_')
...
class AcessaUsuariaConteudo(Base):
    ...
    Conteudo_Informativo: Mapped['ConteudoInformativo'] = relationship('ConteudoInformativo', back_populates='Acessa_Usuaria_Conteudo')
...
class Orgao(Base):
    ...
    Alerta: Mapped[list['Alerta']] = relationship('Alerta', back_populates='Orgao_')
    Denuncia: Mapped[list['Denuncia']] = relationship('Denuncia', back_populates='Orgao_')
